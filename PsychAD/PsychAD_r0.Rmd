...
run_crumblr_analysis = function(pb, form.vp, form.dream, coef){
  ...
  fig.vp = plotPercentBars( sortCols(vp.c), col=cols )
...
coef = "DxAD"
pb = pb.subclass
form.vp = ~ (1|SubID) + (1|poolID) + (1|Sex) + scale(Age) + (1|Dx) + pH + PMI
form.dream = ~ (1|SubID) + (1|poolID) + (1|Sex) + scale(Age) + Dx + pH + PMI
...
form.vp = ~ (1|SubID) + (1|poolID) + (1|Sex) + scale(Age) + pH + PMI
form.dream = ~ (1|SubID) + (1|poolID) + (1|Sex) + scale(Age) + pH + PMI
