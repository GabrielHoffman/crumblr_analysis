...
```{r plot.sims, cache=FALSE, fig.height=4, fig.width=8}
...
```{r plot.sims.mixed, cache=FALSE, fig.height=4, fig.width=8}
CT = "CT_1"
# AUPR
aupr.rand = unique(df_res$AUPR.rnd[!is.na(df_res$AUPR.rnd)])
fig1 = df_res %>%
...
```{r plot.increasing, cache=FALSE, fig.width=8, fig.height=4}
CT = "CT_1"
...
```{r plot.increasing.tau, cache=FALSE, fig.width=8, fig.height=4}
CT = "CT_1"
# AUPR
aupr.rand = unique(df_res$AUPR.rnd[!is.na(df_res$AUPR.rnd)])
fig1 = df_res %>%
...
```{r plot.increase.clusters, cache=FALSE, fig.width=8, fig.height=4}
CT = "CT_1"
...
```{r sim2}  
n_sims = 100
df_res2 = lapply(c( 0, .5, 1, 3), function(var.batch){  
...
```{r sim2.plots, fig.height=4, fig.width=8, cache=FALSE, eval=FALSE}
...
```{r plot.batch.effect, cache=FALSE, fig.width=8, fig.height=8}
CT = "CT_1"
# AUPR
