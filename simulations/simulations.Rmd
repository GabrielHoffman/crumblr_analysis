...
df_res2 = lapply(c(0, .05, .1, .2), function(var.frac){  
	...
	run_three_formulas( n_samples, n_clusters, mean_counts, n_sims = 3000, beta.true, n_batches, var.batch, methods = methods, tau=tau, use.sccoda=FALSE, mc.cores=1, short=FALSE) 
}) 
