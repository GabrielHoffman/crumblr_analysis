...
fig1 = ggplot(df_res[df_res$assay==CT,], aes(method, AUPR, fill=method)) + 
...
fig1 = ggplot(df_res2[df_res2$assay==CT,], aes(factor(var.batch), AUPR, fill=method)) +
	geom_bar(stat="identity", position = "dodge") +
	theme_classic() +
	scale_y_continuous(expand=c(0, 0), limits=c(0, 1)) +
	 theme(aspect.ratio=1, plot.title = element_text(hjust = 0.5)) +
...
# FPR
fig2 = ggplot(df_res2[df_res2$assay==CT,], aes(factor(var.batch), FPR, fill=method)) +
	geom_bar(stat="identity", position = "dodge") +
	theme_classic() +
	scale_y_continuous(expand=c(0, 0), limits=c(0, NA)) +
	 theme(aspect.ratio=1, plot.title = element_text(hjust = 0.5)) +
