...
df_res = run_three_formulas( n_samples, n_clusters, mean_counts, n_sims, beta.true, n_batches, var.batch, methods, tau=1)  
...
df_res = lapply(seq(100, mean_counts_max, by=400), function(mean_counts){
	run_three_formulas( n_samples, n_clusters, mean_counts, n_sims, beta.true, n_batches, var.batch, methods, tau=4) 
})
df_res = do.call(rbind, df_res)
```
