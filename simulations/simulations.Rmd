...
library(reticulate)
python_path = "/hpc/users/hoffmg01/.cache/R/basilisk/1.14.3/0/bin/python"
...
/hpc/users/hoffmg01/.cache/R/basilisk/1.14.3/0/bin/python
import sccoda
import sccoda.util.cell_composition_data
import sccoda.util.comp_ana
...
run_simulation = function( n_samples, n_clusters, mean_counts, n_sims, beta.true, n_batches, var.batch, formula, methods, tau, use.sccoda=FALSE, mc.cores=20){
	...
	df_res = mclapply( 1:n_sims, function(idx){
		...
		if( use.sccoda){
			res = sccoda_wrapper(counts, info, formula, python_path = "/hpc/users/hoffmg01/.cache/R/basilisk/1.14.3/0/bin/python")
...
# scCoda
res = system.time({
		a = sccoda_wrapper(counts, info, formula, python_path = "/hpc/users/hoffmg01/.cache/R/basilisk/1.14.3/0/bin/python")
})
