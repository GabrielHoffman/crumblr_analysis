...
df_res2 = lapply(c(0, .05, .1, .2), function(var.frac){  
	...
	run_three_formulas( n_samples, n_clusters, mean_counts, n_sims, beta.true, n_batches, var.batch, methods = c("lm", "lmlog", "poisson", "binomial", "betabinomial"), tau=tau, use.sccoda=FALSE, mc.cores=48, short=FALSE) 
}) 
