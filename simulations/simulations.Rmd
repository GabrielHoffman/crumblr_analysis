...
ggplot(df_time, aes(Method, pmax(1.5, Time), fill=Method)) +
	geom_bar(stat="identity") +
	theme_classic() +
	theme(aspect.ratio=1, legend.position="none") +
	scale_y_log10("Run time (seconds)", limits=c(NA, NA), expand=c(0,0))  + 
	coord_flip() + 
	scale_fill_manual(values=cols)

ymax = log10(max(df_time$Time)) + 3
ggplot(df_time, aes(Method, log10(Time)+2, color=Method)) +
	geom_bar(stat="identity") +
	geom_point() +
	theme_classic() +
	theme(aspect.ratio=1, legend.position="none") +
	scale_y_continuous("Run time (seconds)", limits=c(0, ymax*1.05), expand=c(0,0), breaks=(0:5), labels=10^(0:5  -2))  + 
	coord_flip() + 
