...
df_res2 = lapply(c(5000), function(mean_counts){  
	df = lapply(c( 0, .5, 1, 3), function(var.batch){  
		run_three_formulas( n_samples, n_clusters, mean_counts, n_sims, beta.true, n_batches, var.batch, methods, tau=tau, use.sccoda=FALSE, mc.cores=mc.cores, short=TRUE)  
	})
	do.call(rbind, df)
})
