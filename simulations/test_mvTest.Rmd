...
ggplot(df, aes(method, FPR, fill=paste(method, shrink.cov))) +
...
fig_FPR = ggplot(df, aes(n_features, FPR, color=paste(method, shrink.cov))) +
  geom_line(size=1) + 
  geom_point() +
  geom_hline(yintercept=0.05, linetype="dashed") +
  theme_classic() +
...
fig_AUPR = ggplot(df, aes(n_positive, AUPR, color=paste(method, shrink.cov))) +
  geom_line(size=1) + 
  geom_point() +
  geom_hline(yintercept=0.1, linetype="dashed") +
  theme_classic() +
