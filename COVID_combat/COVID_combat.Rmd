...
# cd /sc/arion/projects/CommonMind/hoffman/scRNAseq_data/covid19_combat
...
sce = readH5AD("local.h5ad", use_hdf5=TRUE)
...
```{r merge.data}
# read metadata
df = read.table("CBD-KEY-CLINVAR/COMBAT_CLINVAR_for_processed.txt", header=TRUE)
