...
i = pb$Status == levels(pb$Status)[1]
fig1 = plotPercentBars(fracs[i,], col=ggColorHue(ncol(fracs))) + 
  ylab("Cell fractions") + 
  theme(legend.position = "none", axis.text.y=element_blank())

i = pb$Status == levels(pb$Status)[2]
fig2 = plotPercentBars(fracs[i,], col=ggColorHue(ncol(fracs))) + 
  ylab("Cell fractions") + 
  theme(legend.position = "none", axis.text.y=element_blank())

i = pb$Status == levels(pb$Status)[3]
fig3 = plotPercentBars(fracs[i,], col=ggColorHue(ncol(fracs))) + 
  ylab("Cell fractions") + 
  theme(legend.position = "none", axis.text.y=element_blank())

plot_grid(fig1, fig2, rel_widths=c(.75,1, 1))
```
